    ...
    <main className="legal-page">
      ...
      <article className="legal-document shell">
        ...
        {privacy ? <>
          ...
          <section><h2>AI proof checks</h2><p>Before a remote proof check, the app tells you that your proof note and any selected image or short video will be securely proxied through the InsForge edge function to Google's Gemini Developer API for automated assessment. InsForge is only the secure proxy; it does not perform the AI assessment. Images are compressed and stripped of embedded metadata in your browser. Only a hash, media type, size, and optional filename are retained by this app. Google states that free-tier Gemini Developer API submissions may be used to improve its products; paid-tier submissions are not used for that purpose. Never include confidential information, names, faces, private replies, or identifying information.</p></section>
