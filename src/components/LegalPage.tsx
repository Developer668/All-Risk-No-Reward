    ...
    <main className="legal-page">
      ...
      <article className="legal-document shell">
        ...
        {privacy ? <>
          ...
          <section><h2>OpenAI proof checks</h2><p>Challenge loading, filtering, selection, and evidence validation are deterministic and do not use AI. For a synced proof check, you may select multiple images or videos. Your browser prepares images and extracts timestamped still frames from each video, then securely proxies that evidence plus any optional context through the InsForge edge function to OpenAI for visual interpretation against the assigned challenge’s completion criteria. Full videos stay in your browser. InsForge is the secure proxy; it does not perform the AI assessment. Images are resized and re-encoded in your browser. Only a hash of the submitted evidence package, media type, size, optional combined filename, score, and feedback are retained by this app. Never include confidential information, names, private replies, or identifying information.</p></section>
